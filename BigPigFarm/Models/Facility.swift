...
let facilityInfo: [FacilityType: FacilityInfo] = [
    .foodBowl: FacilityInfo(
        ...
        baseCost: GameConfig.Economy.foodBowlCost, description: "Provides food to reduce hunger",
    ...
    .waterBottle: FacilityInfo(
        ...
        baseCost: GameConfig.Economy.waterBottleCost, description: "Provides water for hydration",
        capacity: 200, refillCost: 2,
        healthBonus: 0.0, happinessBonus: 0.0, socialBonus: 0.0,
        breedingBonus: 0.0, growthBonus: 0.0, saleBonus: 0.0, foodProduction: 0),
    .hayRack: FacilityInfo(
        name: "Hay Rack", size: FacilitySize(width: 2, height: 1),
        baseCost: GameConfig.Economy.hayRackCost, description: "Fiber source, +5% health bonus",
        capacity: 200, refillCost: 5,
        healthBonus: 0.05, happinessBonus: 0.0, socialBonus: 0.0,
        breedingBonus: 0.0, growthBonus: 0.0, saleBonus: 0.0, foodProduction: 0),
    .hideout: FacilityInfo(
        name: "Hideout", size: FacilitySize(width: 3, height: 2),
        baseCost: GameConfig.Economy.hideoutCost, description: "Sleep and shelter, +10% happiness",
    ...
    .exerciseWheel: FacilityInfo(
        ...
        baseCost: GameConfig.Economy.exerciseWheelCost, description: "Entertainment and fitness, +5% health",
        capacity: 2, refillCost: 0,
        healthBonus: 0.05, happinessBonus: 0.0, socialBonus: 0.0,
        breedingBonus: 0.0, growthBonus: 0.0, saleBonus: 0.0, foodProduction: 0),
    .tunnel: FacilityInfo(
        name: "Tunnel System", size: FacilitySize(width: 3, height: 1),
        baseCost: GameConfig.Economy.tunnelCost, description: "Exploration and play, +15% happiness",
    ...
    .playArea: FacilityInfo(
        ...
        baseCost: GameConfig.Economy.playAreaCost, description: "Social activities, +social chance",
    ...
    .breedingDen: FacilityInfo(
        ...
        baseCost: GameConfig.Economy.breedingDenCost, description: "Private space for mating",
    ...
    .nursery: FacilityInfo(
        ...
        baseCost: GameConfig.Economy.nurseryCost, description: "Baby care, faster growth",
        capacity: 4, refillCost: 0,
        healthBonus: 0.0, happinessBonus: 0.0, socialBonus: 0.0,
    ...
    .veggieGarden: FacilityInfo(
        ...
        baseCost: GameConfig.Economy.veggieGardenCost, description: "Grows fresh vegetables",
        capacity: 0, refillCost: 0,
        healthBonus: 0.0, happinessBonus: 0.0, socialBonus: 0.0,
    ...
    .groomingStation: FacilityInfo(
        ...
        baseCost: GameConfig.Economy.groomingStationCost, description: "Health and appearance, +15% sale value",
        capacity: 0, refillCost: 0,
        healthBonus: 0.0, happinessBonus: 0.0, socialBonus: 0.0,
    ...
    .geneticsLab: FacilityInfo(
        ...
        baseCost: GameConfig.Economy.geneticsLabCost,
    ...
    .feastTable: FacilityInfo(
        ...
        baseCost: GameConfig.Economy.feastTableCost,
    ...
    .campfire: FacilityInfo(
        ...
        baseCost: GameConfig.Economy.campfireCost,
    ...
    .therapyGarden: FacilityInfo(
        ...
        baseCost: GameConfig.Economy.therapyGardenCost,
    ...
    .hotSpring: FacilityInfo(
        ...
        baseCost: GameConfig.Economy.hotSpringCost,
    ...
    .stage: FacilityInfo(
        ...
        baseCost: GameConfig.Economy.stageCost,
