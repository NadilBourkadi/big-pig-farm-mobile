/// GameTime -- In-game time progression tracker.
/// Maps from: game/game_state.py (GameTime data type)
import Foundation
...
struct GameTime: Codable, Sendable {
    ...
    init(from decoder: Decoder) throws {
        ...
        let decodedDay = try container.decode(Int.self, forKey: .day)
        ...
        clockBaseMinutes = Double((decodedDay - 1) * 1440 + decodedHour * 60 + decodedMinute) - totalGameMinutes
    }
