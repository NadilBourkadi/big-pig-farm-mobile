...
func canonicalGenotype(
    ...
    // E locus: E_ = black/chocolate group, ee = golden/cream group
    // B locus: B_ = black/golden group, bb = chocolate/cream group
    // D locus: D_ = undiluted, dd = diluted (blue/lilac/saffron/smoke)
    let eLocus: AllelePair
    let bLocus: AllelePair
    let dLocus: AllelePair
    switch baseColor {
    case .black:     eLocus = AllelePair(first: "E", second: "E")
                     bLocus = AllelePair(first: "B", second: "B")
                     dLocus = AllelePair(first: "D", second: "D")
    case .chocolate: eLocus = AllelePair(first: "E", second: "E")
                     bLocus = AllelePair(first: "b", second: "b")
                     dLocus = AllelePair(first: "D", second: "D")
    case .golden:    eLocus = AllelePair(first: "e", second: "e")
                     bLocus = AllelePair(first: "B", second: "B")
                     dLocus = AllelePair(first: "D", second: "D")
    case .cream:     eLocus = AllelePair(first: "e", second: "e")
                     bLocus = AllelePair(first: "b", second: "b")
                     dLocus = AllelePair(first: "D", second: "D")
    case .blue:      eLocus = AllelePair(first: "E", second: "E")
                     bLocus = AllelePair(first: "B", second: "B")
                     dLocus = AllelePair(first: "d", second: "d")
    case .lilac:     eLocus = AllelePair(first: "E", second: "E")
                     bLocus = AllelePair(first: "b", second: "b")
                     dLocus = AllelePair(first: "d", second: "d")
    case .saffron:   eLocus = AllelePair(first: "e", second: "e")
                     bLocus = AllelePair(first: "B", second: "B")
                     dLocus = AllelePair(first: "d", second: "d")
    case .smoke:     eLocus = AllelePair(first: "e", second: "e")
                     bLocus = AllelePair(first: "b", second: "b")
                     dLocus = AllelePair(first: "d", second: "d")
    }

    // S locus: SS = solid, Ss = dutch, ss = dalmatian
    let sLocus: AllelePair
    switch pattern {
    case .solid:     sLocus = AllelePair(first: "S", second: "S")
    case .dutch:     sLocus = AllelePair(first: "S", second: "s")
    case .dalmatian: sLocus = AllelePair(first: "s", second: "s")
    }

    // C locus: CC = full, C/ch = chinchilla, ch/ch = himalayan
    let cLocus: AllelePair
    switch intensity {
    case .full:        cLocus = AllelePair(first: "C", second: "C")
    case .chinchilla:  cLocus = AllelePair(first: "C", second: "ch")
    case .himalayan:   cLocus = AllelePair(first: "ch", second: "ch")
    }

    // R locus: rr = none, Rr = roan (never RR — lethal)
    let rLocus: AllelePair
    switch roan {
    case .none: rLocus = AllelePair(first: "r", second: "r")
    case .roan: rLocus = AllelePair(first: "R", second: "r")
    }
