...
@Test func adoptionGetAvailableBloodlinesTier1() {
    let result = Adoption.getAvailableBloodlines(farmTier: 1)
...
@Test func adoptionGetAvailableBloodlinesTier4() {
    let result = Adoption.getAvailableBloodlines(farmTier: 4)
...
@Test func adoptionGetAvailableBloodlinesTier0ReturnsEmpty() {
    let result = Adoption.getAvailableBloodlines(farmTier: 0)
