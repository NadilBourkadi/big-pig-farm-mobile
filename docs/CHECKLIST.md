...
- [x] Profile `GKGridGraph` vs custom A* on 96x56 grid (during Phase 1)
...
- [x] Polish animations and transitions (bead u39)
...
- [x] Schedule local push notifications for offline events: births, facilities, contracts (bead w27l)
